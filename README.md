...
**Comet** is an AI-native web browser developed by **Perplexity** that integrates AI directly into the browsing experience, making search, research, and everyday web tasks faster and more efficient.
